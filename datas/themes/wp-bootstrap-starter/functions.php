...
function wp_bootstrap_starter_reminder(){
        $theme_page_url = 'https://afterimagedesigns.com/wp-bootstrap-starter/';
...
function wp_bootstrap_starter_scripts() {
	...
	wp_enqueue_style( 'wp-bootstrap-starter-main-style', get_template_directory_uri() . '/style.css' );
	...
	// Load other styles
	wp_enqueue_style( 'wp-bootstrap-starter-other-styles', get_template_directory_uri() . '/assets/css/style.css' );
	...
	wp_enqueue_script( 'wp-bootstrap-starter-customjs', get_template_directory_uri() . '/assets/js/custom.js', array(), '20191204', true );
